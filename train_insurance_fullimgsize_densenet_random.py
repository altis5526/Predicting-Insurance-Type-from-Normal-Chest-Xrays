...
if __name__ == "__main__":
    ...
    if args.mode == "train":
        train_dataset = MIMIC_raw_random_label(train_path, transform=True)
        val_dataset = MIMIC_raw_random_label(val_path, transform=True)
    elif args.mode == "test":
        train_dataset = MIMIC_raw_random_label(train_path, transform=True)
        val_dataset = MIMIC_raw_random_label(val_path, transform=False)
